...
<head>
    ...
    <title>Sala Terraza 3</title> <!-- En la BBDD tendría el id 8 -->
                ...
                <div class="section-1"> <!-- Esto sería un grid -->
                    ...
                    <?php
                        ...
                        try {
                            ...
                            $sql = "SELECT * FROM tbl_mesas WHERE id_sala = 8 AND tipo_mesa = 'rectangular'";
                            $stmt = $conn->query($sql);
                ...
                <div class="section-2">
                    ...
                    <?php
                        ...
                        try {
                            ...
                            $sql2 = "SELECT * FROM tbl_mesas WHERE id_sala = 8 AND tipo_mesa = 'cuadrada'";
            ...
            <div class="section-3">
                ...
                <?php
                    ...
                    try {
                        ...
                        $sql3 = "SELECT * FROM tbl_mesas WHERE id_sala = 8 AND tipo_mesa = 'redonda'";
